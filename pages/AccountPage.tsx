        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-12 lg:gap-y-8 items-start">
            <div className="lg:hidden p-4 bg-white border border-gray-200/80 rounded-xl mb-8">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 mt-4 text-sm font-semibold py-3 bg-gray-100 text-black rounded-lg hover:bg-gray-200 transition-colors"
                >
                    {icons.signOut}
                    Sign Out
                </button>
