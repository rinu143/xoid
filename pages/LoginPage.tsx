...
const LoginPage: React.FC = () => {
  ...
  const inputClass = (field: keyof typeof errors) => `
    ...
    placeholder:text-gray-400 focus:border-black focus:ring-black
    ${errors[field] || (field === 'email' && loginError) ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300'}
  `;
          ...
          <div className="relative bg-white rounded-xl shadow-2xl p-8 w-full max-w-md m-4" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handlePasswordReset}>
              <div>
                ...
                <input id="reset-email" name="email" type="email" autoComplete="email" required value={resetEmail} onChange={(e) => setResetEmail(e.target.value)} className="appearance-none relative block w-full px-3 py-3 border border-gray-300 rounded-md placeholder-gray-500 text-black focus:outline-none focus:ring-black focus:border-black sm:text-sm" placeholder="Email address" />
              </div>
              <div className="mt-6">
